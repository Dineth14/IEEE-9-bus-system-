...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{sensitivity_analysis_plots.png}
    \caption{Visual Analysis of Voltage Sensitivity: (a) Voltage Variance Heatmap, (b) Sensitivity Ranking, (c) Voltage Profile for Bus 5 Load Variation, (d) Standard Deviation Comparison.}
