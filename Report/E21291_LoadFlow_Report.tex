...
\lstinputlisting[language=Python, caption=Main Entry Point]{code_appendix/main.py}

\subsection*{A.2 Newton-Raphson Implementation (src/methods/newton\_raphson.py)}
\lstinputlisting[language=Python, caption=Newton-Raphson Solver]{code_appendix/newton_raphson.py}
...
\lstinputlisting[basicstyle=\ttfamily\scriptsize, breaklines=true, caption=Program Output with Timestamp]{execution_proof.txt}
