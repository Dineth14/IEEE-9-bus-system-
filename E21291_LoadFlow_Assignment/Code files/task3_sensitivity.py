...
def run_sensitivity_independent():
    print("="*80)
    print("SENSITIVITY ANALYSIS (Independent P/Q Variation)")
    print("="*80)

    # Setup
    ensure_dir('outputs/tables/sensitivity')
    ...
    df_p.to_csv('outputs/tables/sensitivity/p_sensitivity.csv', index=False)
    df_q.to_csv('outputs/tables/sensitivity/q_sensitivity.csv', index=False)
